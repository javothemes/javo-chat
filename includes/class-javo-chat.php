...
class Javo_Chat
{
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Javo_Chat_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Javo_Chat_Loader. Orchestrates the hooks of the plugin.
	 * - Javo_Chat_i18n. Defines internationalization functionality.
	 * - Javo_Chat_Admin. Defines all hooks for the admin area.
	 * - Javo_Chat_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Javo_Chat_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
